...
1. **MCP layer** — Claude Code ↔ `mcp/server.py` (stdio), which exposes the 32 MCP tools.
...
**Target:** AppleBridge 0.8d47 (protocol v0.2), Python host via launchd, 32 MCP tools
