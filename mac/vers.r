...
resource 'vers' (1) {
    ...
    development, 0x34,   /* development stage, non-release revision 38 (BCD) */
    verUS,
    "0.8d43",            /* short version -> Finder "Version" column + Get Info */
    "AppleBridge 0.8d43 - the console can be shown and hidden from its own menu"  /* long -> Get Info */
};
