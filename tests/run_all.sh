...
files=(test_macbinary.py test_screenshot_decode.py test_screenshot_v2.py test_encoding_convert.py
       ...
       test_mpw_diagnostics.py test_lint_arm.py test_bench_score.py)
