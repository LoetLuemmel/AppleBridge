...
files=(test_macbinary.py test_screenshot_decode.py test_encoding_convert.py
       ...
       test_build_verification.py test_session_brief.py test_notes.py test_notes_field.py test_dlgpatch_contract.py test_rsrc_extract.py test_counter_probe_contract.py test_notes_remote.py)
